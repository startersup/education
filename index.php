<?php
 ...
 if(isset($_SESSION["userid"]))
 {
    echo '<script language="javascript">window.onload = function() {document.getElementById("log").text="'.$_SESSION["uname"].'!";
         document.getElementById("log").setAttribute("data-toggle","false"); document.getElementById("sign").text="Quit"; document.getElementById("sign").setAttribute("data-toggle","false");
