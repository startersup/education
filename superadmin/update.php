...
echo "<div class='modal-header'>
				...
				<form class='form' action='qlist.php' method='post'>
				  <p>Question</p>
                    <textarea name='qns' class='question form-group form-control' style='min-width:300px;min-height:250px;font-size:14px;'>
                    ".$row['question']."
                 </textarea><br>
                     <p>Answer</p>
                    ...
                    <div class='col-xs-6'>
                     ...
                     <p>Explanation</p>
                    <textarea name='exp' class='question form-group form-control'  style='min-width:300px;min-height:250px;font-size:14px;'>
                    ".$row['explanation']."
                 </textarea><br>
